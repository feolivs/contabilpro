...
import { Calendar, CheckSquare, DollarSign, FileText, Loader2 } from 'lucide-react'
...
export function ClientTimelineSection({ clientId }: ClientTimelineSectionProps) {
  ...
  const { events, isLoading, error, hasMore, loadMore, isLoadingMore } = useClientTimeline(
    clientId,
    {
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>Histórico completo de atividades e eventos</p>
      </div>
      ...
      <Tabs
        ...
        onValueChange={v => handleCategoryChange(v as TimelineCategory | 'all')}
      >
