...
import type { TimelineEvent, TimelineEventType, TimelineFilters } from '@/types/timeline'
...
export async function logTimelineEvent(input: {
  ...
  try {
    ...
    // Verificar se o cliente existe (RLS garante acesso apenas ao propriet�rio)
