    ...
    <form action={action} className='grid gap-4 rounded-lg border bg-card p-6 shadow-sm'>
      <div>
        ...
        <p className='text-sm text-muted-foreground'>
          Informe IDs de cliente e conta contábil para registrar um lançamento simples.
        </p>
      </div>
      ...
      <div className='grid gap-2'>
        ...
        <Input id='description' name='description' required disabled={isPending} placeholder='Serviços prestados' />
